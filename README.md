...
@adobe/aio-cli-plugin-auth/1.1.2 darwin-x64 node-v10.18.1
$ aio --help [COMMAND]
USAGE
  $ aio COMMAND
...
...
_See code: [src/commands/auth/index.js](https://github.com/adobe/aio-cli-plugin-auth/blob/v1.1.2/src/commands/auth/index.js)_
...
_See code: [src/commands/auth/ctx.js](https://github.com/adobe/aio-cli-plugin-auth/blob/v1.1.2/src/commands/auth/ctx.js)_
...
_See code: [src/commands/auth/login.js](https://github.com/adobe/aio-cli-plugin-auth/blob/v1.1.2/src/commands/auth/login.js)_
...
_See code: [src/commands/auth/logout.js](https://github.com/adobe/aio-cli-plugin-auth/blob/v1.1.2/src/commands/auth/logout.js)_
<!-- commandsstop -->
